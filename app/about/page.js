...
export default function About() {
  return (
    ...
    >
      ...
      <section className="flex flex-col md:flex-row items-center gap-8 mb-16 bg-card p-6 rounded-xl border border-border">
        ...
        <div className="space-y-4">
          <h2 className="text-3xl font-semibold text-foreground" style={{ fontFamily: "var(--font-serif)" }}>
            Welcome!
          </h2>
          <p className="text-lg leading-relaxed text-muted-foreground" style={{ fontFamily: "var(--font-sans)" }}>
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-6 text-foreground" style={{ fontFamily: "var(--font-serif)" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="flex items-start gap-3 p-4 bg-card rounded-lg border border-border">
            <PenTool className="w-6 h-6 text-primary mt-1" />
            <span className="text-lg text-foreground">
      ...
      <section className="space-y-6 pb-10 text-center">
        ...
        <p className="text-lg leading-relaxed text-muted-foreground max-w-2xl mx-auto" style={{ fontFamily: "var(--font-sans)" }}>
